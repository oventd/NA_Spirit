...
# MongoDB 연결
client = MongoClient("mongodb://localhost:27017/")  # 여기에 본인의 MongoDB 주소 입력
...
texture_assets = [
    {
        "name": "pineapple",
        "description": "A 3D model of a pineapple with a textured surface and green leaves.",
        "preview_url": "/nas/spirit/DB/thum/3d_assets/thum013.png"
    },
    {
        "name": "ceiling_light",
        "description": "A modern ceiling light fixture with a sleek circular design.",
        "preview_url": "/nas/spirit/DB/thum/3d_assets/thum014.png"
    }
]
